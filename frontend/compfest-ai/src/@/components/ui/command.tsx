...
>(({ className, ...props }, ref) => (
  <div className="yesflex yesitems-center yesborder-b yespx-3" cmdk-input-wrapper="">
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.List
    ref={ref}
    className={cn("yesmax-h-[300px] yesoverflow-y-auto yesoverflow-x-hidden", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      "yesrelative yesflex yescursor-default yesselect-none yesitems-center yesrounded-sm yespx-2 yespy-1.5 yestext-sm yesoutline-none data-[disabled=true]:yespointer-events-none data-[selected='true']:yesbg-accent data-[selected=true]:yestext-accent-foreground data-[disabled=true]:yesopacity-50",
      className
    )}
    {...props}
  />
